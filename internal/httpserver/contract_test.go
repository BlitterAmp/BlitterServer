...
func TestEveryUnimplementedOperationAnswersHonestly(t *testing.T) {
	...
	implemented := map[string]bool{
		...
		"getMyLastfm": true, "connectMyLastfm": true, "disconnectMyLastfm": true, "completeLastfmAuth": true,
		...
		"adminUpdateProfile": true, "adminDeleteProfile": true, "adminAnonymizeProfileData": true,
