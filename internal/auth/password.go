// Package auth owns credential hashing: the admin password and profile PINs
// persist only as argon2id PHC strings.
package auth
...
// HashPassword returns an argon2id PHC string for storage.
